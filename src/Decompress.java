...
public class Decompress{
	...
	/**
	 * Default constructor.
	 * Runs the file to be decoded through the methods required to decode it.
	 *
	...
	/**
	 * Reads in the remaining bytes of the file and the first 8 have been read.
	 * Converts the bytes to binary digits.
	 * If the binary digits length < 8, it will append 0 to the beggining of it.
	 *   ex: 14 ---> 1110
	 *      after addition: 00001110
	 *
	...
	/**
	 * Reads in the first 8 bytes of the file and converts it to an integer.
	 * The integer value is the amount of bytes in the original file.
	 *
	...
	/**
	 * Builds a tree off of the given data.
	 * After building the tree, sends remaining data to decode method
	 *
	...
	private void buildTree(String str){
		...
		//Receiving the tree, uses algorithm found in lecture 13B slide 14
		/**
		create a stack
	...
	/**
	 * Decodes the tree.
	 * Based on byteCount, that is the amount of the bytes that are read.
	 * Writes data to file.
	 *
